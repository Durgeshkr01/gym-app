...
export default function MessageSettingsScreen({ navigation }) {
  ...
  const templateDefs = [
    { key: 'welcome', label: 'Welcome Message', icon: 'hand-wave', color: '#4CAF50',
      ...
      defaultWA: 'Welcome to SG Fitness 2.0, {name}! 🏋️\nYour Roll No: {rollNo}\nPlan: {plan}\nLet\'s achieve your fitness goals together! 💪',
      defaultSMS: 'Welcome to SG Fitness 2.0, {name}! Roll No: {rollNo}, Plan: {plan}. Happy training!',
    },
    { key: 'renewal', label: 'Renewal Reminder', icon: 'refresh', color: '#2196F3',
      ...
      defaultWA: 'Hi {name}, your {plan} membership is expiring on {endDate}. Please renew to continue your fitness journey! 💪 - SG Fitness 2.0',
      defaultSMS: 'Hi {name}, your {plan} membership expires on {endDate}. Please renew. - SG Fitness 2.0',
    },
    { key: 'expiry', label: 'Expiry Notice', icon: 'clock-alert', color: '#FF9800',
      ...
      defaultWA: 'Hi {name}, your gym membership has expired on {endDate}. We miss you! Come renew today. 🏋️ - SG Fitness 2.0',
      defaultSMS: 'Hi {name}, membership expired on {endDate}. Please renew. - SG Fitness 2.0',
    },
    { key: 'birthday', label: 'Birthday Wish', icon: 'cake-variant', color: '#E91E63',
      desc: 'Auto-sent on member birthday. Variables: {name}',
      defaultWA: 'Happy Birthday {name}! 🎂🥳 Wishing you an amazing year ahead!\nEnjoy your special day. - SG Fitness 2.0',
      defaultSMS: 'Happy Birthday {name}! Wishing you a great year. - SG Fitness 2.0',
    },
    { key: 'dues', label: 'Dues Reminder', icon: 'cash-remove', color: '#F44336',
      desc: 'Sent for payment reminders. Variables: {name}, {due_amount}',
      defaultWA: 'Dear {name}, you have pending dues of ₹{due_amount} at SG Fitness 2.0.\n\nPlease clear your dues at your earliest convenience.\n\nThank you! 🙏',
      defaultSMS: 'Dear {name}, pending dues ₹{due_amount} at SG Fitness 2.0. Please clear soon.',
    },
    { key: 'general', label: 'General Notice', icon: 'bullhorn', color: '#9C27B0',
      desc: 'For broadcast announcements. Variables: {name}',
      defaultWA: 'Hi {name}, this is an announcement from SG Fitness 2.0. We hope to see you at the gym soon! 💪',
      defaultSMS: 'Hi {name}, announcement from SG Fitness 2.0.',
    },
    { key: 'checkin', label: 'Attendance Alert', icon: 'clock-check', color: '#009688',
      desc: 'Sent when member checks in. Variables: {name}',
      defaultWA: 'Hi {name}! 💪 Your attendance has been marked at SG Fitness 2.0.\nKeep crushing your goals! 🏋️',
      defaultSMS: 'Hi {name}, attendance marked at SG Fitness 2.0. Keep it up!',
    },
