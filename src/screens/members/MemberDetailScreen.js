...
const styles = StyleSheet.create({
  ...
  headerCard: { margin: 15, elevation: 4, borderRadius: 12 },
  ...
  quickActions: { flexDirection: 'row', paddingHorizontal: 15, marginBottom: 10 },
  ...
  card: { marginHorizontal: 15, marginBottom: 12, elevation: 2, borderRadius: 10 },
  ...
  actionRow: { flexDirection: 'row', paddingHorizontal: 15, marginBottom: 10, flexWrap: 'wrap' },
